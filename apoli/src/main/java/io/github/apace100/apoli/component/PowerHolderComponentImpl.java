...
public class PowerHolderComponentImpl implements PowerHolderComponent {
    ...
    protected boolean removePower(Power power, Identifier source, boolean root) {
        ...
        if (power == null) {
            Apoli.LOGGER.error(errorMessage.append(" from entity ").append(owner.getName().getString()).toString());
            return false;
        }
    ...
    protected boolean addPower(Power power, Identifier source, boolean root) {
        ...
        if (power == null) {
            Apoli.LOGGER.error(errorMessage.append(" to entity ").append(owner.getName().getString()).toString());
            return false;
        }
